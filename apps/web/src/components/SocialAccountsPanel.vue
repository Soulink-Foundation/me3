...
const oauthMessage = computed(() => {
  if (oauthConnected.value === "x") {
    return "X connected. It will now appear as a publish target in the blog editor.";
  }
  if (oauthConnected.value === "linkedin") {
    return "LinkedIn connected. It will now appear as a publish target in the blog editor.";
  }
  if (oauthConnected.value === "instagram") {
    return "Instagram connected. It will now appear as a publish target in the blog editor.";
  }
  if (oauthConnected.value === "instagram_business") {
    return "Instagram (Business) connected. It will now appear as a publish target in the blog editor.";
  }
  if (oauthConnected.value === "youtube") {
    return "YouTube connected. It will now appear as a publish target in the blog editor.";
  }
  return null;
});
